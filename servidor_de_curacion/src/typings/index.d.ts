declare namespace fhir {
  ...
  interface DiagnosticReport extends DomainResource {
    ...
    request?: Reference[];
    specimen?: Reference[];
    result?: Reference[]; //?? not in documentation
    imagingStudy?: Reference[];
    image?: DiagnosticReportImage[];
    conclusion?: string;
    codedDiagnosis?: CodeableConcept[];
    presentedForm?: Attachment[]; //TODO
  }
  ...
  interface FamilyMemberHistory extends DomainResource {
    ...
    date?: dateTime;
    status: code;
    notDone?: boolean; //?? not in documentation
    notDoneReason?: CodeableConcept; //?? not in documentation
    name?: string;
    relationship: CodeableConcept;
    gender?: code;
    bornPeriod?: Period;
    ...
    deceasedAge?: Age;
    deceasedRange?: Range; //TODO
    deceasedDate?: date;
    deceasedString?: string;
    reasonCode: CodeableConcept[];
    reasonReference: Reference[];
    note?: Annotation[]; //TODO
  ...
  interface ImagingStudySeriesPerformer extends Element {
